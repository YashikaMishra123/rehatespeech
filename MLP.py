...
from transformers import ElectraTokenizer, ElectraForPreTraining, AdamW, BertTokenizer, TFBertModel, BertConfig
...
balanced_df.tail()
# Assuming 'text' and 'label' are the column names in your CSV
